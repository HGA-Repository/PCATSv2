...
spRPRT_CostReport_NewAcct2_Vision @Project='8.110021.00.0',@Rprtdate='2013-03-25 00:00:00',@ReportCase=1
spRPRT_CostReport_NewAcct2_Vision @Project='8.110021.01.0',@Rprtdate='2013-03-25 00:00:00',@ReportCase=1
spRPRT_CostReport_NewAcct2_Vision @Project='8.110021.02.0',@Rprtdate='2013-03-25 00:00:00',@ReportCase=1
spRPRT_CostReport_NewAcct2_Vision @Project='8.110021.03.0',@Rprtdate='2013-03-25 00:00:00',@ReportCase=1
spRPRT_CostReport_NewAcct2_Vision @Project='8.110021.04.0',@Rprtdate='2013-03-25 00:00:00',@ReportCase=1
spRPRT_CostReport_NewAcct2_Vision @Project='8.110021.05.0',@Rprtdate='2013-03-25 00:00:00',@ReportCase=1
spRPRT_CostReport_NewAcct2_Vision @Project='8.110021.06.0',@Rprtdate='2013-03-25 00:00:00',@ReportCase=1
spRPRT_CostReport_NewAcct2_Vision @Project='8.110021.99.0',@Rprtdate='2013-03-25 00:00:00',@ReportCase=1
...
SELECT
	...
	, tasks.Description as AcctGroup
...
FULL OUTER JOIN (
	...
	where bud.WBS1 like @Project AND ISNUMERIC(SUBSTRING(bud.[Account],6,4)) = 1
...
LEFT JOIN(
   ...
   (
	...
	JOIN DT_ForecastToCompletes ftc on ftc.ForecastID = fu.ID AND fu.Project = @Project 
		and fu.DateCreated = ( SELECT MAX([DateCreated]) FROM DT_ForecastUpdates WHERE [Project] like @Project )
