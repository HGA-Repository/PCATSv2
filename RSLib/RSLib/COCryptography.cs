...
namespace RSLib
{
	public class COCryptography
	{
        ...
        public static string EncryptStringPassword(string val, string eKey, string vector)
        {
        ...
        public static string DecryptStringPassword(string val, string eKey, string vector)
        {
