...
namespace RSMPS
{
    public class rprtPCNExpenses_New : GrapeCity.ActiveReports.SectionReport
    {
        public event RevSol.PassDataString OnExpensesTotalled;

      //  public event RevSol.PassMultiDataStrings OnExpensesTotalled;// Added 9/4/2015

        public event HandleTotalValues OnTotalRun;

        public rprtPCNExpenses_New()
        {
            InitializeComponent();
        }
