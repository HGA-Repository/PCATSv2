...
namespace RSMPS
{
  //  public delegate void HandleTotalValues(decimal value1, decimal value2, decimal value3);
    ...
    public class rprtBudgetDetail_WorkSheet_PCN_Expense : GrapeCity.ActiveReports.SectionReport
    {
        int miExpNumItems;
        decimal mdExpMuDlrs;
        ...
        public rprtBudgetDetail_WorkSheet_PCN_Expense()
        {
            InitializeComponent();
        }
        ...
        private void GroupFooter1_Format(object sender, System.EventArgs eArgs)
        {
            ...
            rprtPCNExpenses_New PCNexp = new rprtPCNExpenses_New();
            PCNexp.OnExpensesTotalled += new RevSol.PassDataString(rExp_OnExpensesTotalled);
            PCNexp.DataSource = this.DataSource;
            PCNexp.DataMember = "Table2";
            PCNexp.OnTotalRun += new HandleTotalValues(PCNexp_OnTotalRun);
            //this.subReport1.Report = PCNexp;
            subReport1.Report = PCNexp;

           // try
           // {
           //     PCNexp.DataSource = ((DataSet)this.DataSource).Tables["Table2"].Select(fltrVal);
          //  }
           // catch { }
         //  PCNexp.SetTitle(txtDiscipline.Value.ToString(), txtDepartment.Value.ToString());
        ...
        void PCNexp_OnReportTotaled(string[] vals, int count) //*************************Added 9/4/2015
        {
            miExpNumItems += Convert.ToInt32(vals[0]);
            mdExpMuDlrs += Convert.ToDecimal(vals[1]);
            mdExpTotDlrs += Convert.ToDecimal(vals[2]);
        }
        void rExp_OnExpensesTotalled(string val) //*************************Added 9/4/2015
        {
            decimal exp;
        ...
        void PCNexp_OnTotalRun(decimal value1, decimal value2, decimal value3)
        {
            currentExpenseValue = value1;
        }
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(rprtBudgetDetail_WorkSheet_PCN_Expense));
            ...
            this.subReport1,
            this.label12});
            this.GroupFooter1.Height = 1.395833F;
            ...
            this.subReport1.Height = 0.25F;
            this.subReport1.Left = 0.445F;
            this.subReport1.Name = "subReport1";
            this.subReport1.Report = null;
            this.subReport1.Top = 1.053F;
            ...
            this.label12.Left = 0.1458333F;
            this.label12.Name = "label12";
            this.label12.Style = "background-color: LightSeaGreen";
            this.label12.Text = "PCN";
            this.label12.Top = 0.7708333F;
            this.label12.Width = 1.052083F;
            // 
            // rprtBudgetDetail_WorkSheet_PCN_Expense
            // 
