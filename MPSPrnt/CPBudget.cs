...
namespace RSMPS
{
    public class CPBudget
    {
        ...
        public void PreviewGetTravelExpenseReport(int budID, string wbs, bool rate) //***********************Added 7/22/2015
        {
            FPreviewAR pv = new FPreviewAR();
            //rprtBudgetSummary1 rprt = new rprtBudgetSummary1();
        ...
        public void PreviewDetail_WorkSheet_Expenses(int budID, string wbs) //*******************************Added 8/31/2015
        {
            FPreviewAR pv = new FPreviewAR();
            rprtBudgetDetail_WorkSheet_Expense rprt = new rprtBudgetDetail_WorkSheet_Expense();
            ...
            ds = CBBudget.GetWorksheet_Expenses_DetailsForReport(budID, wbs);
        ...
        {
            FPreviewAR pv = new FPreviewAR();
            rprtTravelExpenses rprt = new rprtTravelExpenses();
            ...
            ds = CBBudget.GetWorksheet_TravelExpenses_DetailsForReport(budID);

            //GetWorksheet_TravelExpenses_DetailsForReport
            //if (proj.BusinessUnit() == 1) rprt.MainReportTitle = "Staffing Estimate Loaded Details";
            //if (proj.BusinessUnit() == 2) rprt.MainReportTitle = "Engineering Estimate Loaded Details";
          //  if (proj.BusinessUnit() == 3) rprt.MainReportTitle = "Pipeline Services Estimate Loaded Details";
          //  if (proj.BusinessUnit() == 4) rprt.MainReportTitle = "Program Management Estimate Loaded Details";
        ...
        public void PreviewDetail_SpecificationProcurement(int budID) //*******************************Added 8/31/2015
        {
            FPreviewAR pv = new FPreviewAR();
            rprtSpecificationProcurement rprt = new rprtSpecificationProcurement();
            ...
            ds = CBBudget.GetBudgetDetails_SpecificationProcurementForReport(budID);
