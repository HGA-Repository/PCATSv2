...
namespace RSMPS
{
    public class rprtBudgetSummaryExpenses : GrapeCity.ActiveReports.SectionReport
    {
        ...
        public void InitializeComponent()
        {
            ...
            this.Label.Style = "font-size: 12pt; font-weight: bold; vertical-align: middle";
            ...
            this.ReportStart += new System.EventHandler(this.rprtBudgetSummaryExpenses_ReportStart);
        ...
        private void rprtBudgetSummaryExpenses_ReportStart(object sender, EventArgs e) //******************Added 7/22/2015
        {
            if (mbRate == false)
            {
