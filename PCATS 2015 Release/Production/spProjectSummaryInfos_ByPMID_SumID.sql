...
/****** Object:  StoredProcedure [dbo].[spProjectSummaryInfos_ByPMID_SumID]    Script Date: 8/5/2015 3:41:39 PM ******/
SET ANSI_NULLS ON
GO
...
WHERE
	...
	p.ID not in (select projectid from DT_ProjectSummaryInfos where ProjSumID = @ProjSumID)
