/****** Object:  StoredProcedure [dbo].[spRPRT_DrawingLogByDept]    Script Date: 5/27/2015 11:35:14 AM ******/
DROP PROCEDURE [dbo].[spRPRT_DrawingLogByDept]
GO
...
CREATE PROCEDURE [dbo].[spRPRT_DrawingLogByDept]
@DepartmentID	int,
@SortCode	int
AS
