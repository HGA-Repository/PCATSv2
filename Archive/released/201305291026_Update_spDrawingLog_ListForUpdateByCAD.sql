...
/****** Object:  StoredProcedure [dbo].[spDrawingLog_ListForUpdateByCAD]    Script Date: 05/29/2013 14:15:30 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spDrawingLog_ListForUpdateByCAD]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spDrawingLog_ListForUpdateByCAD]
GO
...
CREATE PROCEDURE [dbo].[spDrawingLog_ListForUpdateByCAD]
@DepartmentID	int,
@ProjectID		int,
@WBS	varchar(5)
AS
