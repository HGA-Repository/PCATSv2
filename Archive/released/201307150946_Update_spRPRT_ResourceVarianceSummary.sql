...
/****** Object:  StoredProcedure [dbo].[spRPRT_ResourceVarianceSummary]    Script Date: 07/09/2013 13:35:52 ******/
...
/*
EXEC [dbo].[spRPRT_ResourceVarianceSummary] 0
EXEC [dbo].[spRPRT_ResourceVarianceSummary] 1
*/
...
SELECT
	...
	,JSRmn = case WHEN d.AcctGroup = 11000 THEN SUM(ROUND(ps.MPRmn,0))
		ELSE SUM(ROUND(ps.JSRmn,0)) END
