...
namespace RSMPS
{
    public class CDbBudgetExpenseLine
    {
        private COBudgetExpenseLine oVar;
        ...
        public int SaveNew(string strXml)
        {
            ...
            cnn = new RSLib.CDbConnection();
            cmd = new SqlCommand("spBudgetExpenseLine_Insert", cnn.GetConnection());
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public int SavePrev(string strXml)
        {
            ...
            cnn = new RSLib.CDbConnection();
            cmd = new SqlCommand("spBudgetExpenseLine_Update", cnn.GetConnection());
            cmd.CommandType = CommandType.StoredProcedure;
