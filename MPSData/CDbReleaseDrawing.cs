...
namespace RSMPS
{
    public class CDbReleaseDrawing
    {
        COReleaseDrawing oVar;
        ...
        public string GetByID(int lID)
        {
            ...
            cmd = new SqlCommand("spReleaseDrawing_ByID", cnn.GetConnection());
        ...
        public int SaveNew(string strXml)
        {
            ...
            cnn = new RSLib.CDbConnection();
            cmd = new SqlCommand("spReleaseDrawing_Insert", cnn.GetConnection());
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public int SavePrev(string strXml)
        {
            ...
            cnn = new RSLib.CDbConnection();
            cmd = new SqlCommand("spReleaseDrawing_Update", cnn.GetConnection());
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        private void LoadVals(string strXml)
        {
            ...
            oVar = new COReleaseDrawing();
            oVar = (COReleaseDrawing)s.Deserialize(sr);
        ...
        public bool Delete(int lID)
        {
            ...
            cnn = new RSLib.CDbConnection();
            cmd = new SqlCommand("spReleaseDrawing_Delete", cnn.GetConnection());
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public SqlDataReader GetList()
        {
            ...
            cnn = new RSLib.CDbConnection();
            cmd = new SqlCommand("spReleaseDrawing_ListAll", cnn.GetConnection());
            cmd.CommandType = CommandType.StoredProcedure;
