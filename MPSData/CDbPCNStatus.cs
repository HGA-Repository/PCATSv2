...
namespace RSMPS
{
    public class CDbPCNStatus
    {
        private COPCNStatus oVar;
        ...
        public int SaveNew(string strXml)
        {
            ...
            cnn = new RSLib.CDbConnection();
            cmd = new SqlCommand("spPCNStatus_Insert", cnn.GetConnection());
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public bool Delete(int lID)
        {
            ...
            cnn = new RSLib.CDbConnection();
            cmd = new SqlCommand("spPCNStatus_Delete", cnn.GetConnection());
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public SqlDataReader GetList()
        {
            ...
            cnn = new RSLib.CDbConnection();
            cmd = new SqlCommand("spPCNStatus_ListAll", cnn.GetConnection());
            cmd.CommandType = CommandType.StoredProcedure;
