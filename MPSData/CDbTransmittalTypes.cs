...
namespace RSMPS
{
    public class CDbTransmittalTypes
    {
        private COTransmittalTypes oVar;
        ...
        public string GetByID(int lID)
        {
            ...
            cmd = new SqlCommand("spTransmittalType_ByID", cnn.GetConnection());
        ...
        public int SaveNew(string strXml)
        {
            ...
            cnn = new RSLib.CDbConnection();
            cmd = new SqlCommand("spTransmittalType_Insert", cnn.GetConnection());
            cmd.CommandType = CommandType.StoredProcedure;
            ...
            prm = cmd.Parameters.Add("@Code", SqlDbType.VarChar, 2);
            prm.Value = oVar.Code;
        ...
        public int SavePrev(string strXml)
        {
            ...
            cnn = new RSLib.CDbConnection();
            cmd = new SqlCommand("spTransmittalType_Update", cnn.GetConnection());
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public bool Delete(int lID)
        {
            ...
            cnn = new RSLib.CDbConnection();
            cmd = new SqlCommand("spTransmittalType_Delete", cnn.GetConnection());
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public SqlDataReader GetList()
        {
            ...
            cnn = new RSLib.CDbConnection();
            cmd = new SqlCommand("spTransmittalType_ListAll", cnn.GetConnection());
            cmd.CommandType = CommandType.StoredProcedure;
