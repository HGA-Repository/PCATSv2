...
namespace RSMPS
{
    public class CDbProjectEmployee
    {
        ...
        public SqlDataReader GetListActiveWithHoursProp(int deptID, DateTime sDate, DateTime eDate)
        {
            SqlDataReader dr;
            RSLib.CDbConnection cnn;
            SqlCommand cmd;
            ...
            cnn = new RSLib.CDbConnection();
            cmd = new SqlCommand("spProjectEmployee_ListActiveWithHoursProp", cnn.GetConnection());
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        public SqlDataReader GetListActiveWithHoursProject(int Proj_ID, DateTime sDate, DateTime eDate)
        {
            SqlDataReader dr;
            RSLib.CDbConnection cnn;
            SqlCommand cmd;
            ...
            cnn = new RSLib.CDbConnection();
            cmd = new SqlCommand("spProjectEmployee_ListActiveWithHoursProject", cnn.GetConnection());
            cmd.CommandType = CommandType.StoredProcedure;
