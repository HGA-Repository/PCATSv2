...
/****** Object:  StoredProcedure [dbo].[spRPRT_BudgetDetail]    Script Date: 3/11/2016 8:01:17 AM ******/
SET ANSI_NULLS ON
GO
...
alter PROCEDURE [dbo].[spRPRT_BudgetDetail]
@BudgetID	int,
@WBS	varchar(5)
AS
...
ORDER BY
	...
	deptGrps.[DeptGroup] ASC, bl.[Activity] ASC, bl.Description asc  ---------- Edited 3/11/2016, MZ
