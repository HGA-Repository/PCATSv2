...
/****** Object:  StoredProcedure [dbo].[spRPRT_CostReport_NewAcct2_Vision]    Script Date: 06/04/2013 10:06:08 ******/
...
where 
	...
	AND ISNULL(budget_line_totals.total_dollars,0) 
		+ ISNULL(budgets.Budget,0) + ISNULL(budgets.BudgetHrs,0) + ISNULL(actuals.TotalHrs,0) 
